...
public final class DesktopPaint {
    ...
    /** Well board gold lip — same band as web {@code boardRimBreath}. */
    public static double boardRimAlpha(double wave) {
    ...
    public static double discStroke(double diameter, double radiusFrac) {
        return discStroke(diameter, radiusFrac, 0.07);
    }
    ...
    /** Top of an open side, halfway from the paver mix into the catch under the shine. */
    public static String wallSideJoinInk(String wall, String floor, String shine) {
        String side = wallFootInk(wall, floor);
        if (shine == null) {
            return side;
        }
