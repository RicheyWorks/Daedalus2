...
class WebUiSmokeTest {
    ...
    void theWebUiIsServedAtTheRoot() {
        ...
        assertThat(html).contains("DAEDALUS").contains("id=\"gate\"").contains("id=\"gateWell\"")
                ...
                .contains("color: #f2ead8; user-select: none; -webkit-user-select: none; -webkit-tap-highlight-color: transparent;")
                ...
                .contains("animation: stageRimBreath 4.5s ease-in-out infinite; -webkit-tap-highlight-color: transparent; outline: none")
                .contains("#1a1510 0%")
                .contains("#16120e 0%")
