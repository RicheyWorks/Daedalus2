...
class WebUiSmokeTest {
    ...
    void theWebUiIsServedAtTheRoot() {
        ...
        assertThat(html).contains("DAEDALUS").contains("id=\"gate\"").contains("id=\"gateWell\"")
                ...
                .contains("background: #16120e; color: #d4c4a8; cursor: text")
                ...
                .contains("max-height: 22vh; color: #d4c4a8; cursor: text")
                ...
                .contains("#tourBox td { padding: 2px 8px; border-bottom: 1px solid rgba(184, 133, 56, 0.28); -webkit-user-drag: none")
                ...
                .contains("#campaignBox div { border-bottom: 1px solid rgba(184, 133, 56, 0.28); -webkit-user-drag: none")
