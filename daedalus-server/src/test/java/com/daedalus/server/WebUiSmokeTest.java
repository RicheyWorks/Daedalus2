...
class WebUiSmokeTest {
    ...
    void theWebUiIsServedAtTheRoot() {
        ...
        assertThat(html).contains("DAEDALUS").contains("id=\"gate\"").contains("id=\"gateWell\"")
                ...
                .contains("letter-spacing: .03em; color: #b09a72")
                ...
                .contains("#tourBox a, #tourBox a:visited { color: #d4a04c; text-decoration: none; }")
                ...
                .contains("#campaignBox a, #campaignBox a:visited { color: #d4a04c; text-decoration: none; }")
