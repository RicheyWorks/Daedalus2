...
class WebUiSmokeTest {
    ...
    void theWebUiIsServedAtTheRoot() {
        ...
        assertThat(html).contains("DAEDALUS").contains("id=\"gate\"").contains("id=\"gateWell\"")
                ...
                .contains("rel=\"mask-icon\" color=\"#996f31\"")
                ...
                .contains("#compareBox tr.solver-row:hover { background: rgba(26, 22, 16, 0.62)")
                .contains("#compareBox tr.pinned { background: rgba(26, 22, 16, 0.62)")
                .contains("#compareBox { max-height: 22vh")
                .contains("scrollbar-color: rgba(153, 111, 49, 0.45) transparent")
                .contains("color: #f2ead8")
                ...
                .contains("#log .solver { color: #af8441;")
                ...
                .contains("box-shadow:0 0 0 1.5px rgba(198, 190, 174, .28)\"></span>${label}")
