...
| Parcel permissions | **SHIPPED — inspect + grant/deny/revoke + gate** | Allow/deny lists exist on the parcel. REST grant/deny/revoke extra-list actors. `block.place` asks ParcelGate. DAEW v10 persists extras. Last drive persists as DAEW v11. Last drive actor persists as DAEW v12. Last drive at persists as DAEW v13. No wallet. |
